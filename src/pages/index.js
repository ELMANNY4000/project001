        ...
        <div className="row pt-5 ">
          <div className="col-lg-6 pt-lg-5 pe-lg-5">
            ...
            <p className="hero-text mb-5">
              FraudCovr is built for global internet transactions facing
            ...
            <div className="Report-btn-cont position-relative">
              <Link href="https://docs.google.com/forms/d/e/1FAIpQLSci2f-8g84ZjXV0gLa-yc80udugxgARiYE9hW91OKbrE_LodA/viewform?usp=sharing">
                <button className="position-relative Report-btn text-decoration-none py-3 border-0 rounded text-center text-white contact-btn">
                  Report a fraud
                </button>
              </Link>
              <Image
          ...
          <div class="col how-card position-relative">
            <div className="how-card-cont d-flex flex-column justify-content-between h-100">
              <Image
                src={CardSearch}
                alt="card image"
                className="mb-0 mb-lg-5 img-fluid"
              />
              <div className="z-1">
                <div className="how-card-heading my-3 my-lg-0 fw-normal ">
                  Search our database
                </div>
            ...
            <div className="how-card-num num-width1 position-absolute m-0">
              1
            </div>
          </div>
          <div class="col how-card position-relative">
            ...
            <div className="how-card-num num-width2 position-absolute m-0">
              2
            </div>
          </div>
          <div class="col how-card position-relative">
            <div className="how-card-cont d-flex flex-column justify-content-between h-100">
              ...
              <div className="z-1">
                ...
                <div className="how-card-content w-100 position-relative">
                  Match results can contain multiple parameters our aim is to
                  find the closest matches to your search results
                </div>
              </div>
            </div>
            <div className="how-card-num num-width2 position-absolute m-0">
          ...
          <div class="col how-card position-relative">
            <div className="how-card-cont d-flex flex-column justify-content-between h-100">
              ...
              <div className="z-1">
                ...
                <div className="how-card-content w-100 position-relative">
                  Our tool provide the necessary information to help you decide
                  on next steps,
                </div>
              </div>
            </div>
          ...
          <div className="py-5 px-lg-5 d-lg-flex bg-black">
            <div className="col col-lg-6 px-3 px-lg-0 d-flex justify-content-center align-items-center">
              <Image
                src={Shield}
                alt="shield"
                className="img-fluid pb-4 px-lg-0"
              />
            </div>
          ...
          <div className="overflow-hidden position-relative">
            ...
            <div className="py-5 px-lg-5 d-lg-flex ">
              <div className="col col-lg-6">
                ...
                <button className=" text-decoration-none p-3 border-0 rounded text-center text-white contact-btn">
                  Coming soon
                </button>
                <p className=" p-text pt-4">
                  Effective systems should identify fraud without blocking
                  legitimate payments. Read our primer on how machine learning
                  can produce predictive models of fraud from large sets of
                  data.
                </p>
                <ul className="">
                  <li className="shield-item fw-semibold fs-6 py-2 p-text">
                ...
                <button
                  onClick={() =>
                    router.push(
                      "https://docs.google.com/forms/d/e/1FAIpQLSci2f-8g84ZjXV0gLa-yc80udugxgARiYE9hW91OKbrE_LodA/viewform?usp=sharing"
                    )
                  }
                  className="position-relative Report-btn text-decoration-none py-3 border-0 rounded text-center text-white contact-btn"
                >
                  Report a fraud
                </button>
              </div>
            ...
            <div className="d-lg-flex px-2 px-lg-5 position-relative newsletter-cont">
              ...
              <form className="col col-lg-7 z-1 d-xl-flex ">
                ...
                <div className="pt-md-3 pt-xl-0">
                  <button className="col-5 col-md-auto text-decoration-none p-3 border-0 rounded text-center text-white contact-btn text-nowrap">
                    Join Now
                  </button>
                </div>
              </form>
        ...
        <div className="row pt-5 mt-lg-5 position-relative">
          <div className="position-relative victim rounded-4">
            <Image
              src={Arrow2}
              alt="arrow"
              className="arrow2 d-none d-lg-block z-2 position-absolute "
            />
            <div className="overflow-hidden position-relative ">
              <Image
                src={Gradient3}
                alt="gradient"
                className="gradient3 d-none d-lg-block position-absolute "
              />
                ...
                <div className="col-lg-6 pt-lg-5">
                  ...
                  <div className="">
                    <button
                      ...
                      className="Report-btn text-decoration-none py-3 border-0 rounded text-center text-white contact-btn"
                    >
                      Report a fraud
                    </button>
                  </div>
